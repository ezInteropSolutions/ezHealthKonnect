                ...
                "steps": [{
                    ...
                    "config": {
                        ...
                        "fields": [
                            ...
                            {"targetPath": "facility.identifier.system", "literalValue": "http://hl7.org/fhir/sid/us-npi", "condition": {"field": "claim.facilityNpi", "operator": "exists"}},
                            {"targetPath": "facility.identifier.value", "sourcePath": "claim.facilityNpi"},
                        ...
                        "repeatingGroups": [
                            ...
                            },
                            {
                                ...
                                "fields": [
                                    ...
                                    {"targetPath": "productOrService.coding[0].code", "sourcePath": "revenueCode"},
                                    {"targetPath": "productOrService.coding[1].system", "sourcePath": "procedureSystem"},
                                    {"targetPath": "productOrService.coding[1].code", "sourcePath": "procedureCode"},
                                    {"targetPath": "quantity.value", "sourcePath": "quantity"},
                                    {"targetPath": "net.value", "sourcePath": "net"},
                                    {"targetPath": "net.currency", "literalValue": "USD"},
                                    {"targetPath": "servicedDate", "sourcePath": "servicedDate", "transform": "x12_date_to_fhir_date"},
                                    {"targetPath": "servicedPeriod.start", "sourcePath": "servicedStart", "transform": "x12_date_to_fhir_date"},
                                    {"targetPath": "servicedPeriod.end", "sourcePath": "servicedEnd", "transform": "x12_date_to_fhir_date"}
                                ]
                            },
                            {
                                "targetPath": "careTeam",
