                ...
                "steps": [{
                    ...
                    "config": {
                        ...
                        "fields": [
                            ...
                            {"targetPath": "identifier[0].value", "sourcePath": "steps.derive_837i_claim_contexts.step_output._billing_provider.npi"},
                            {"targetPath": "name", "sourcePath": "steps.derive_837i_claim_contexts.step_output._billing_provider.name"}
                        ]
                    },
                    "enabled": true,
                    "required": true
